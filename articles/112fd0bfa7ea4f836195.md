...
|options.type|引数の型です|string 型を示す 3 にしています^[[optionsの型指定に関するドキュメント](https://discord.com/developers/docs/interactions/slash-commands#application-command-object-application-command-option-type)]|
