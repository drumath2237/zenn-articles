...
Interaction の内容自体は`req.body.data`の中に格納されています。次のデータは公式ドキュメント^[https://discord.com/developers/docs/interactions/slash-commands#receiving-an-interaction]から引用したものです。
