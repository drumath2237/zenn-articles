...
しかしこれには問題があり、通常の人間ではありえないような回転が可能になってしまいます。このように意図しない回転が指定されることでボーンが辺に曲がってしまう現象を**骨折**といい、モーションキャプチャーをする際などで起こってしまうと見ているのがとても辛いです。

そのような事態が起きないように、Unity の Humanoid ではボーンの回転角に制限をつけることができます。
この制限をつけるシステムのことを**muscle システム**と呼びます。
...
すると、インスペクタからmuscle値を操作することができます。
