...
このように意図しない回転が指定されることでボーンが変な曲がり方をしてしまう現象を**骨折**といいます。骨折がモーションキャプチャーをする際などで起こってしまうと、見ているのがとても辛いです......特に自分のアバターで起きたりすると......。
...
基本的に、指の muscle 値も他と同じように[最小値, 最大値]を$\left[ -1.0, 1.0 \right]$にマッピングしたものを設定するのですが、ちょっと仕様が独特です。

まずはどの muscle が指制御に関わっているのかを調べてみましょう。HumanTrait というクラスに muscle に関するいろいろな事柄が定義されているので参照してみます。
